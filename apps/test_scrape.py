...
# send response
response_score = requests.get('https://www.metacritic.com/browse/albums/release-date/new-releases/date', headers = user_agent)
...
for artist in soup_score.find_all('td', class_='clamp-summary-wrap'):
    print(artist.find('div', class_='clamp-details').find('span').text)
#     # scrape album name
